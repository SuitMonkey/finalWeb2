            ...
            <section class="login_content">
                <form METHOD="POST" enctype="multipart/form-data" action="/userLogin">
                    ...
                    <div class="separator">
                        ...
                        <div>
                            <h1><i class="fa fa-plus-circle"></i> Atlantic Shop!</h1>
                            <p>©2017 All Rights Reserved. <br>Atlantic Shop Privacy and Terms</p>
                        </div>
                    </div>
                </form>
            </section>
            ...
            <section class="login_content">
                <form action="/newUser" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="separator">
                        ...
                        <div>
                            <h1><i class="fa fa-plus-circle"></i> Atlantic Shop!</h1>
                            <p>©2017 All Rights Reserved. Atlantic Shop. Privacy and Terms</p>
                        </div>
                    </div>
                </form>
            </section>
